...
release = '1.0'
html_last_updated_fmt = 'April 8, 2022'
...
pdf_documents = [('index', u'Power-Management-Tutorials', u'Power Management GitHub Docs', u'Xilinx, Inc.'),]
...
htmlhelp_basename = 'Power-Management-Tutorials'
